...
public final class EntityDef
{
	...
	public static EntityDef forID(int i)
	{
		...
		if(i == 9001){
			...
			entityDef.standAnim = 10464;
			entityDef.walkAnim = 10465;
			entityDef.anInt58 = 10465;
			entityDef.anInt83 = 10465; 
			entityDef.anInt55 = 10465;	
			entityDef.actions = new String[5];
			entityDef.actions[1] = "Attack";
			entityDef.combatLevel = 280;
			entityDef.description = "It's a Ganodermic beast.".getBytes();
		}
		if(i == 9000){
			entityDef.anIntArray94 = new int[1];
			...
			entityDef.description = "It's a Nex.".getBytes();
		}
		for(i = 0; i < 5000; i++) {
		String examineID = "It's a " + entityDef.name +".";
		entityDef.description = examineID.getBytes();
		}
		return entityDef;
	}
	...
	public static void unpackConfig(StreamLoader streamLoader)
	{
        ...
        Stream stream2 = new Stream(getData((new StringBuilder()).append(signlink.findcachedir()).append("npc.idx").toString()));
