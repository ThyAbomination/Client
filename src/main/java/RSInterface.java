...
public final class RSInterface {
	...
	RSInterface tab = addScreenInterface(15020);
	addSprite(15009, 0, "Starter/BOX");
	addHoverButton(15010, "Starter/ATTACK", 1, 99, 64, "Choose Attack", -1, 15011, 1);
	addHoveredButton(15011, "Starter/ATTACKH", 0, 98, 64, 15051);
	addHoverButton(15012, "Starter/MAGIC", 2, 99, 64, "Choose Magic", -1, 15013, 1);
	addHoveredButton(15013, "Starter/MAGICH", 0, 98, 64, 15052);
	addHoverButton(15014, "Starter/RANGE", 3, 99, 64, "Choose Range", -1, 15015, 1);
	addHoveredButton(15015, "Starter/RANGEH", 0, 98, 64, 15053);
	addText(15016, "Choose A Starter", tda, 3, 0xff66ff00, false, true);
	tab.totalChildren(8);
	tab.child(0, 15009, 48, 65);
	tab.child(1, 15010, 335, 110);
	tab.child(2, 15011, 335, 110);
	tab.child(3, 15012, 207, 110);
	tab.child(4, 15013, 207, 110);
	tab.child(5, 15014, 82, 110);
	tab.child(6, 15015, 82, 110);
	tab.child(7, 15016, 197, 70);
	}
...
private static Sprite LoadSprite(int i, String s) {
        ...
        try {
            sprite = new Sprite("./Cache/Sprite"+s+" "+i+".PNG");
            aMRUNodes_238.removeFromCache(sprite, l);
        } catch (Exception exception) {
...
public static void addLunar3RunesLargeBox(int ID, int r1, int r2, int r3, int ra1, int ra2, int ra3,int rune1, int rune2, int lvl,String name, String descr,TextDrawingArea[] TDA, int sid,int suo,int type){
	...
	setBounds(ID+7, 142, 92, 8, INT);
		...
		addLunar3RunesSmallBox(30064, 9075, 563, 557, 1, 0, 1, 30012, 30006, 68, "Ourania Teleport","Teleports you to Ourania cave",TDA,6,0,5);
		addLunar3RunesBigBox(30075, 9075, 563, 557, 1, 0, 3, 30012,  30006, 69,"Moonclan Teleport", "Teleports you to Lunar isle",TDA, 7,0,5);
		addLunar3RunesSmallBox(30083, 9075, 563, 557, 1, 0, 5, 30012, 30006, 70, "Tele Group Moonclan","Teleports players to Lunar isle",TDA,8,0,5);
		...
		addLunar3RunesBigBox(30138, 9075, 563, 554, 1, 1, 2, 30012, 30003, 74,"Barbarian Teleport", "Teleport you to Barbarian outpost",TDA, 15,0,5);
		addLunar3RunesBigBox(30146, 9075, 563, 554, 1, 1, 5, 30012, 30003, 75,"Tele Group Barbarian\\noutpost", "Teleports players to the Barbarian\\noutpost",TDA, 16,0,5);
