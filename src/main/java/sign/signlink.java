    ...
    implements Runnable
{
	...
	{
		boolean exists = (new File(System.getProperty("user.home") + "/.pd_cache/")).exists();
		if (exists) {
			return System.getProperty("user.home") + "/.pd_cache/";
		} else {
			File f = new File(System.getProperty("user.home") + "/.pd_cache/");
			f.mkdir();
			return System.getProperty("user.home") + "/.pd_cache/";
		}
	}
